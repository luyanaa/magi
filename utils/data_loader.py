...
class PairedBrainDataset(Dataset):
    """
    Paired EEG-fMRI dataset for cross-modal training.
    ...
    def _auto_align(self):
        ...
        for key in common_keys:
            self.pair_list.append((eeg_files[key], fmri_files[key]))
            self.metadata[key] = {"eeg": eeg_files[key], "fmri": fmri_files[key]}
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        ...
        eeg_path, fmri_path = self.pair_list[idx]
